...
const Gallery = () => {
  ...
  return (
    <div className=' bg-black flex flex-col gap-20 justify-center items-center py-[3rem] px-[3rem] md:flex-row '>
      <div className='flex-1 flex sm:min-w-[100%] md:min-w-[500px] lg:min-w-[500px] xl:min-w-500px justify-center items-center'>
      ...
      <div className='flex-1 flex flex-row max-w-[100%] sm:max-w-[50%]  relative'>
        <div className='flex flex-row w-max overflow-x-scroll container' ref={scrollRef}>
          {imageGallery.map((image, index) => {
            return <div className='relative  min-w-[301px]  h-[447px]  mr-[2rem] flex justify-center items-center  hover:opacity-[0.35]' key={`gallery-image-${index + 1}`} >
